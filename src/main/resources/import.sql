...
INSERT INTO RESOURCE (ID, NAME, DESCRIPTION, PLACE, OWNER_ID) VALUES (1, 'PC Gamer ROXOR', 'Je vous présente mon magnifique PC gamer surpuissant de la mort qui fait tout tourner au max', '45 rue des Oiseaux 44000 NANTES', 1);
INSERT INTO RESOURCE (ID, NAME, DESCRIPTION, PLACE, OWNER_ID) VALUES (2, 'Costume de scientifique', 'Tout est dans le titre', '85 rue des Hirondelles 44000 NANTES', 1);